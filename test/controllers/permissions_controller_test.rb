...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { reader_id: @permission.reader_id, user_id: @permission.user_id }
    end
  ...
  test "should update permission" do
    patch :update, id: @permission, permission: { reader_id: @permission.reader_id, user_id: @permission.user_id }
    assert_redirected_to permission_path(assigns(:permission))
  end
